...
function Main() {
    ...
    return (
        <div className='w-full Main'>
            <div className='h-screen flex flex-col justify-center items-center gap-10 mainbg text-white'>
                <div className=''>
                    <h1 className='text-center font-bold text-4xl lg:text-6xl'>SHRI VAIBHAVI SILKS</h1>
                    <h1 className='text-center text-xl italic pt-10 lg:text-2xl'><span className='font-bold'>Sarees</span> truly are dresses with a soul</h1>
                </div>
